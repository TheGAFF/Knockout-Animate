...
koAnimate.animations =
{
    ...
    slide: function (element, pixelsX, pixelsY, duration)
    {
        ...
        $.each(koAnimate.helpers.cssVendors, function (index, item)
        {
            $(element).css(item + 'transform', 'translate(' + pixelsX + ',' + pixelsY + ')').css(item + 'transition', seconds + 's ease');
        });
    }
};
...
ko.bindingHandlers.hoverScale =
{
    update: function (element, json)
    {
        ...
        {
            koAnimate.animations.scale(element, scaleOut, durationOut);
        });
    }
};
...
ko.bindingHandlers.hoverRotate =
{
    update: function (element, json)
    {
        ...
        ko.utils.registerEventHandler(element, "mouseenter", function ()
        {
            koAnimate.animations.rotate(element, degrees, duration);
        });

        ko.utils.registerEventHandler(element, "mouseleave", function ()
        {
            koAnimate.animations.rotate(element, degreesOut, durationOut);
        });
    }
};
...
ko.bindingHandlers.slideVisible =
{
    init: function (element, json)
    {
        ...
        {
            $(element).hide();
            koAnimate.animations.slide(element, koAnimate.helpers.getDirectionX(directionOut), 0);
        }
    },
    update: function (element, json)
    {
